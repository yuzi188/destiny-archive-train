...
export async function POST(request: Request) {
  ...
  const prompt = [
    ...
    "每一章 lines 必須保留原本命理/星盤判讀，再追加白話註解。格式固定為：前 2 句是盤面判讀，最後 1 句必須以「白話：」開頭。",
    "白話註解要把盤面翻成生活行為，例如『白話：你常先扛再說累』，不可重複前一句。",
    "限制：這是娛樂/自我反思內容，不要做醫療、法律、投資、保證命運的斷言。",
    "字數規則非常重要：title 最多 14 字，headline 最多 20 字，一般 lines 固定 3 句，每句最多 22 個中文字。",
    "有 headline 的章節也必須輸出 3 句 lines，其中第 3 句是白話註解。",
    "第四章 triangulation 固定 3 句，每句最多 24 字；第四章 lines 固定 2 句，每句最多 22 字，其中至少 1 句以「白話：」開頭。",
